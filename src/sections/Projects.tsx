            ...
            >
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  <div className="bg-gradient-to-r from-emerald-300 to-sky-500 inline-flex font-bold uppercase tracking-widest text-sm gap-2 text-transparent bg-clip-text">
                  ...
                  <a href={project.link}>
                    <button className="bg-white text-gray-950 h-12 w-full md:w-auto md:px-8 rounded-full font-semibold inline-flex items-center justify-center gap-2 mt-8">
